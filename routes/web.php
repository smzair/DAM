...
Route::get('/lot-Ar', 'ComController@lotAr')->name('viewlotAr');
Route::get('/get-LOTar-rejection', 'ComController@commentrejection');
Route::post('/arlot-aproval', 'ComController@lotaproval');
Route::post('/update-LOTar-comment', 'ComController@Lotarcomment');
...
Route::post('/plan-shoot-ajax', 'adminController@planShoot');
...
Route::get('/get-service-Wrcs','timesheet@getserviceWrc');
Route::get('/timesheet','timesheet@index')->name('timepunch');
Route::get('/timesheet-am','timesheet@amIndex')->name('timepunch');
Route::post('/save-time','timesheet@save');
Route::get('/get-wrc-time-history','timesheet@wrcHistory');
Route::get('/sos-Tat/{id}','Notifications@SOS');
Route::get('/performa','invoicingController@PI');
Route::get('/performafinduser','invoicingController@findUser');
Route::get('/performadetail','invoicingController@findDetails');
Route::get('/performacommercials','invoicingController@findcom');
Route::get('/performacom','invoicingController@com');
Route::get('/performasave','invoicingController@save');
Route::get('/performaRequest','invoicingController@viewRequest');
Route::get('/comperformaRequest','invoicingController@viewappRequest');
Route::get('/getpreDetail','invoicingController@perDetail');
Route::get('/upadatepi/{id}','invoicingController@Piapprove');
Route::get('/upadateProforma/{id}/{service}','invoicingController@ProformaUpdate');
Route::get('/rejectepi/{id}','invoicingController@Reject');
Route::get('/pipdf/{service}/{performa_id}','invoicingController@generatePDF');
Route::get('/viewpdf/{performa_id}','invoicingController@viewPDF');
Route::get('/status-index','overallstatusShoot@index');
Route::post('/performaupdate','invoicingController@update');
Route::get('/public-Data','overallstatusShoot@publicData');
Route::get('/status-get','overallstatusShoot@statusGet');
Route::get('/raised-inovice','SubmissionController@raisedWrc'); 
Route::get('/ready-inovice','SubmissionController@invoiceR'); 
Route::get('/raise-for-inovice','SubmissionController@raiseIN')->name('raise-for-inovice'); 
Route::get('/create-invoice','invoicingController@createInvoice');
Route::get('/paytments-inovice','invoicingController@payDetails');
Route::get('/getinvoiceDetail','invoicingController@getinDetails');
Route::post('/save-raised-invoice','invoicingController@saveDetails');
Route::get('/updateInvoice','invoicingController@updateInvoice');
Route::post('/invoice-no-up','invoicingController@updateInvoiceno');
Route::get('/invoice-details','invoicingController@invoiceDetail');
Route::get('/Raised_Invoice','invoicingController@invoiceRaised');
Route::get('/Time-sheet-notify','timesheet@getNotify');
...
Route::get('/download-shoot-lot-raw/{id}/{is_multipal?}', [ImageDownloadController::class, 'download_Shoot_Lot_raw'])->name('download_Shoot_Lot_raw'); //shoot-lot-raw Image download

Route::get('/download-shoot-lot-Edited-image/{id}/{is_multipal?}', [ImageDownloadController::class, 'download_Shoot_Lot_edited'])->name('download_Shoot_Lot_edited'); //shoot-lot-Edited Image download

Route::get('/download-Editing-lot-raw/{id}/{is_multipal?}', [ImageDownloadController::class, 'download_Editing_Lot_raw'])->name('download_Editing_Lot_raw'); //shoot-lot-raw Image download

Route::get('/download-Editing-lot-edited/{id}/{is_multipal?}', [ImageDownloadController::class, 'download_Editing_Lot_edited'])->name('download_Editing_Lot_edited'); //shoot-lot-raw Image download
...
Route::get('/Editing-lot-Edited-wrc-Images/{wrc_id}/{is_multipal?}', [ImageDownloadController::class, 'download_Editing_lot_Edited_wrc'])->name('download_Editing_lot_Edited_wrc'); //Editing-lot-Edited Image download not done

Route::get('/Shoot-lot-Edited-adaptation-Images/{wrc_id}/{adaptation}/{sku_id?}/{is_multipal?}', [ImageDownloadController::class, 'download_Shoot_lot_Edited_adaptation'])->name('download_Shoot_lot_Edited_adaptation'); //shoot-lot-Edited Image download Wrc and adaptation wise

Route::get('/Shoot-lot-raw-sku-Images/{wrc_id}/{sku_id?}/{is_multipal?}', [ImageDownloadController::class, 'download_Shoot_lot_raw_sku'])->name('download_Shoot_lot_raw_sku'); //shoot-lot-Edited Image download Wrc and adaptation wise
