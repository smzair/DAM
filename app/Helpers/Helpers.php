  ...
  function getTypeOfShootList($id = '')
  {
    $typeOfShootList =
      array(
        ...
        'Editing- High Res' => 'Editing- High Res',
        'Image Resizing' => 'Image Resizing',
        'Editing-TIFF' => 'Editing-TIFF',
        'Furniture Shot' => 'Furniture Shot',
        'Raw Images' => 'Raw Images',
        'Creative videos' => 'Creative videos',
        'prop shots' => 'prop shots',
        'Reels Day' => 'Reels Day',
        'Stills' => 'Stills',
        'Reel' => 'Reel',
        'Motion Graphic' => 'Motion Graphic',
        'Adapts-Still' => 'Adapts-Still',
        'Adapts-Reel' => 'Adapts-Reel',
        'Adapts-Motion Graphic' => 'Adapts-Motion Graphic',
        '60 sec film' => '60 sec film',
        '15 sec Pre-Buzz edits' => '15 sec Pre-Buzz edits',
        'Edited still shot' => 'Edited still shot',
        'Adapts - 60 sec film' => 'Adapts - 60 sec film',
        'Adapts - 15 sec Pre-Buzz edits' => 'Adapts - 15 sec Pre-Buzz edits',
        'Adapts - Edited Still Shots' => 'Adapts - Edited Still Shots'
      );
  ...
  function getAdaptationsList($id = '')
  {
    $adaptationsList =
      array(
        ...
        'Blinkit' => 'Blinkit',
        'Myntra Uber' => 'Myntra Uber',
        'Myntra Super Premium' => 'Myntra Super Premium',
        'Myntra Stylecast' => 'Myntra Stylecast',
        'Instagram' => 'Instagram',
        'Facebook' => 'Facebook',
        'Youtube' => 'Youtube',
        'Pintrest' => 'Pintrest'
  ...
  function getProductList($id = '')
  {
    $productList =
      array(
        ...
        'Luggage' => 'Luggage',
        'Lingerie Bra & Knickers' => 'Lingerie Bra & Knickers',
        'Mens Nightwear' => 'Mens Nightwear',
        'Womens Nightwear' => 'Womens Nightwear',
        'Lingerie/Mens Undergarments' => 'Lingerie/Mens Undergarments',
        'Luggage & Rucksacks' => 'Luggage & Rucksacks',
        'Sarees' => 'Sarees',
        'Lehengas' => 'Lehengas',
        'Suits & Sets' => 'Suits & Sets',
        'Women Lingerie/Nightwear/Sleepwears' => 'Women Lingerie/Nightwear/Sleepwears',
        'Kidswear' => 'Kidswear',
        'Handbags, Luggage & Backpacks' => 'Handbags, Luggage & Backpacks',
        'Men & Women Flat Lays' => 'Men & Women Flat Lays',
        'Additional- Catalog Videos (10 secs, rotation)' => 'Additional- Catalog Videos (10 secs, rotation)',
        'Additional- 1 Model shoot for Fashion Accessories' => 'Additional- 1 Model shoot for Fashion Accessories',
        'Mobile Holder' => 'Mobile Holder',
        'Mobile Holder on table' => 'Mobile Holder on table',
        'Earphone Pouches' => 'Earphone Pouches',
        ...
        'Others(Men/Women/Kids/Accessories )' => 'Others(Men/Women/Kids/Accessories )',
        'Creative Shoot' => 'Creative Shoot',
        'Influencer Shoot' => 'Influencer Shoot',
        'New Born Baby Banner Creative Shoot ' => 'New Born Baby Banner Creative Shoot'
      );
...
if (!function_exists('kindOfWork')) {
  function kindOfWork()
  {
    $kindOfWork  = (object) array(
      ...
      array(
        'id' => "82",
        'value' => 'Creative Content Writing'
      ),
      array(
        'id' => "82",
        'value' => 'Manpower (Junior)'
      ),
      array(
        'id' => "82",
        'value' => 'Manpower (Senior)'
      ),  array(
        'id' => "83",
        'value' => '    Product Title & Description'
      ), array(
        'id' => "84",
        'value' => 'Dimension Image'
      ),
      array(
        'id' => "85",
        'value' => 'Title'
      ...
      array(
        'id' => "86",
        'value' => 'Logo addition in videos'
      ),
      array(
        'id' => "87",
        'value' => 'Unique Banners'
      ),
      array(
        'id' => "88",
        'value' => 'Banner Adapts'
...
if (!function_exists('getTypeOfService')) {
  ...
  function getTypeOfService()
  {
    $getTypeOfService = array(
      ...
      'Elaborated feature translation' => 'Elaborated feature translation',
      ...
      'Manpower (Junior)' => 'Manpower (Junior)',
      'Manpower (Senior)' => 'Manpower (Senior)',
      'Management' => 'Management',
      'Listing (Sports)' => 'Listing (Sports)',
      'Listing (Non-Sports)' => 'Listing (Non-Sports)',
      'Content Scraping + Listing (Sports)' => 'Content Scraping + Listing (Sports)',
      'Content Scraping + Listing (Non-Sports)' => 'Content Scraping + Listing (Non-Sports)',
      'Content Scraping + Listing (Sports)' => 'Content Scraping + Listing (Sports)',
      'Only Title translalion' => 'Only Title translalion',
      'Only Intro translalion' => 'Only Intro translalion',
      'Size Chart translalion' => 'Size Chart translalion',
      'Title' => 'Title',
      'Title & Description' => 'Title & Description',
      'Listing File Creation' => 'Listing File Creation',
      'Links Scraping' => 'Links Scraping',
      'Additional Attributes translation' => 'Additional Attributes translation'
...
if (!function_exists('get_lot_wrc_data')) {
  ...
  {
    $lotdata = EditingWrc::where('lot_id', '=', $lot_id)->select(
