...
<head>
    ...
    <!-- Common Style  -->
    <link rel="stylesheet" src="/dist/css/style.css">
<style type="text/css">
    * {
    margin: 0;
    padding: 0;
...
<body>
    <div class="site-wrapper start-page-wrapper">
        <div class="header-container-wrapper">
            <div class="page-center">
                <div class="container">
                    <div class="custom-header-content">
                        <div class="custom-logo col-header">
                            <a href="https://odndigital.com/" class="logo-link" target="_blank">
                                <img src="/Images/logo.svg" alt="ODN">
                            </a>
                        </div>
                        ...
                        <div class="custom-main-section yellow-section">
                            <div class="main-p-content">
                                <div class="custom-action-btn-wrapper">
                                    <a href="/feedback-start/{{$id}}" class="btn">
                                        START
                                    </a>
                                </div>
                            </div>
...
<script type="application/javascript" src="{{asset('plugins/jquery-ui/jquery-ui.min.js')}}"></script>
    <script type="text/javascript" src="http://127.0.0.1:8000/dist/js/javascript.js"></script>
