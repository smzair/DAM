					...
					<div class="accordion accordion-flush" id="accordionFlushExample">
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingOne">
								<button class="mySvg clickable svg-container accordion-button siderbar-button {{$active_tab == 1 ? '' : 'collapsed'}}" type="button" data-bs-toggle="collapse"
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingTwo">
								<button class="mySvg clickable svg-container accordion-button siderbar-button {{$active_tab == 2 ? '' : 'collapsed'}}" type="button" data-bs-toggle="collapse"
              ...
              data-bs-parent="#accordionFlushExample">
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingThree">
								<button class="mySvg clickable svg-container accordion-button siderbar-button {{$active_tab == 3 ? '' : 'collapsed'}}" type="button" data-bs-toggle="collapse"
