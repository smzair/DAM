														...
														<tbody>
															@foreach ($wrc_with_order_qty as $wrc_val)
																<tr>
																	...
																	<td class="text-wrap">{{$wrc_val['sku_qty']}}</td>
												...
												<table class="table">
													...
													<tbody>
														...
														<tr>
															<td class="text-wrap">{{$wrc_val['wrc_number']}}</td>
															{{-- @dd($wrc_val); --}}
															@if ($wrc_val['overall_status'] == 'Pending' || $wrc_val['overall_status'] == "")
															...
															@if ($wrc_val['overall_status'] == "done")
												...
												<table class="table">
													...
													<tbody>
														@foreach ($Submission_link_details as $sub_val)
																@php
																$final_link_link_arr = explode(',',$sub_val['final_link_link_arr']);
																$catalog_link_arr = explode(',',$sub_val['catalog_link_arr'])
																@endphp
															<tr>
																...
																<td>
																	<ul class="list-group mt-2">
																		@foreach($final_link_link_arr as $key => $val)
																		@if($val == "")
																...
																<td>
																	<ul class="list-group mt-2" >
																		@foreach($catalog_link_arr as $ckey => $cval)
																		@if($cval == "")
