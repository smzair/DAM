            ...
            <div class="row">
              <div class="under-content-div">
                ...
                <div>
                    ...
                    <p class="inward-qty-num"  id="lot_number{{$row['lot_id'].$lot_index}}">{{$row['lot_number']}}</p>
                </div>
              ...
              <div class="under-content-div">
                ...
                <div class="col-12 d-flex d-flex justify-content-between">
                  <div>
                    ...
                    <p class="your-asset-lotno-underbox">{{$row['brand_name']}}</p>
                    <p class="file-lot-date-para">Lot date: <span class="your-asset-lot-date"> {{dateFormet_dmy($row['lot_created_at'])}} </span></p>
                    {{-- myPopover --}}
                    <div class="myPopover" style="display: none;">
                      @php
                          $download_route_is = "download_Editing_Lot_edited";
...
{{-- Marketing Creative & Listing Lots --}}
<div class="row">
  <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="row">
            <div class="under-content-div">
              <div class="col-12 d-flex d-flex justify-content-between">
                ...
                <div type="button" class="btn border-0 rounded-circle myButton">
                  <i class="bi bi-three-dots-vertical" style="color: #9F9F9F;"></i>
                </div>
              </div>

              <div>
                <p class="lot-no-heading">Lot no.</p>
                <p class="inward-qty-num" id="lot_number{{$row['brand_id'].$lot_index}}">{{$row['lot_number']}}</p>
              </div>
        ...
        <div class="col-lg-4 col-md-6 box border-0" style="position: relative;" id="div_{{$tbl_id}}">
          <div class="row">
            <div class="under-content-div">
              ...
              <div>
                <p class="lot-no-heading">Lot no.</p>
                <p class="inward-qty-num" id="lot_number{{$row['id'].$lot_index}}">{{$row['lot_number']}}</p>
              </div>
