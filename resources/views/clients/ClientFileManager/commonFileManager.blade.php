...
@section('main_content')
	...
	<div class="content-wrapper dashboard-content-wrapper">
                ...
                <div class="card-body table-responsive p-0"  style="max-height: 700px; height: 100%;">
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            <form id="searchForm" action="{{ url('commonsearch')}}" method="POST">
                                @csrf
        ...
        @include('clients.ClientFileManager.clientsRawImagesYears')
        @endif

        @if(count($monthly_data)>0)
        @include('clients.ClientFileManager.clientsRawImagesMonths')
        @endif

        @if(count($lotData)>0)
        @include('clients.ClientFileManager.clientsRawImages')
        @endif

        @if(count($wrc_data)>0)
        @include('clients.ClientFileManager.WrcViewForClientsRawImages')
        @endif

        @if(count($sku_data)>0)
        @include('clients.ClientFileManager.SkuViewForClientsRawImages')
        @endif

        @if(count($file_data)>0)
        @include('clients.ClientFileManager.UploadedImagesViewForClientsRawImages')
        @endif
