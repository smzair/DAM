...
<div class="row" style="margin-top: 40px; padding:0px 24px;">
	...
	<div class="col-lg-12 d-flex mt-3">
		<ul class="nav nav-pills mb-3 nav-fill" id="pills-tab" role="tablist" style="padding:12px">
			{{-----lot status Shoot start---}}
			@if (count($shoot_lots) > 0 &&  ($user_role == 'Client' || $your_assets_permissions['shoot']))
			<li class="nav-item" role="presentation">
				<button class="nav-link active btn-lg tab-button border border-dark border-start-0 border-top-0 border-bottom-0" id="pills-home-tab" data-bs-toggle="pill"
