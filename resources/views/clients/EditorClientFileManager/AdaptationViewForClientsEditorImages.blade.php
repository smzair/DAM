                    ...
                    <div class="col-sm-12">
                        <div class="card card-transparent card-info mt-3">
                            <div class="card-header">
                                <h6 class="card-title">All Adaptation</h6>
                            </div>
                            <div class="row">
                                @foreach($adaptation_data as $key=>$object)
                                    <div class="col-md-2">
                                        <div class=" justify-content-between align-content-center">
                                            <div class="text-center">
                                                <a id="folder"  ondblclick="navigateToLink('adaptation/{{$object->adaptation.'-'.$object->sku_id}}')">
                                                ...
                                                <div id="popup-container-{{ $key }}" class="popup-container">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="#" onclick="copyToClipboard('{{route('downloadAdaptationData', ['id' => $object->adaptation.'-'.$object->sku_id])}}'  , 'adaptation'); return false;">
                                                                Copy Link
                                                            </a>
                                                        </li>
                                                    </ul>
