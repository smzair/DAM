...
@if (count($wrc_data) > 0)
	...
	<div class="row" style="margin-top: 12px;">
				...
				<div class="accordion-item">
					...
					<div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headingSix"
						...
						<div class="accordion-body">
							...
							<div class="col-12">
								<p class="Assign-tags">+ Assign tags</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-lg-3 col-md-6  mt-2">
			<div class="accordion accordion-flush" id="accordionFlushExample">
				<div class="accordion-item">
					<h2 class="accordion-header" id="flush-headingsSeven">
						<button class="btn collapsed siderbar-button rounded-0" type="button" data-bs-toggle="collapse"
					...
					<div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven"
						...
						<div class="accordion-body">
							...
							<div class="row">
								<div class="col-12">
									<button type="button" class="btn btn-sm under-acco-button">Winter collection</button>
								</div>
