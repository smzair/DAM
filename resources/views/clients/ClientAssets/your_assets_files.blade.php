...
@if (count($shoot_lots) > 0 || count($editor_lots) > 0 )
	<div class="row ps-lg-3 pe-lg-3" style="margin-top: 40px;" id="File">
		<div class="col-lg-12 d-flex your_assets_tab" style="background: #1A1A1A;">
			<ul class="nav nav-pills mb-3 nav-fill ps-2 pe-2" id="pills-tab" role="tablist" style="padding: 16px 16px 0px 16px">
				{{-- Shoot Lots --}}
