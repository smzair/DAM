									...
									<div class="card brand-img-m border-0 rounded-0">
										...
										<div class="card-body d-flex justify-content-between" style="position: relative">
											...
											<div class="myPopover" style="display: none; top 20%;">
												...
												<a href="javascript:void(0)" onclick="copyUrlToClipboard('url_{{$key}}' , 'Editing Lot Edited Image' , 'Editing lot')" >Share</a>
										...
										<div class="card brand-img-m border-0 rounded-0">
											...
											<div class="card-body d-flex justify-content-between" style="position: relative">
												...
												<div class="myPopover" style="display: none; top 20%;">
													...
													<a href="javascript:void(0)" onclick="copyUrlToClipboard('url_{{$key.$row['upladed_img_id']}}' , 'Editing Lot raw Image' , 'Editing Raw')" >Share</a>
