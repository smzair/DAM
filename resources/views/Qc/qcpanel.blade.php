                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle">Inward SKU Count</th>
                                     <th class="align-middle">Rejected SKU Count</th>
                            ...
                            <tbody>
                                ...
                                <tr id="{{$qc['lot_id']}}_{{$qc['wrc_id']}}" class="collapse" data-parent= "#accordion1" >
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-0 align-top" width="35%">Category</th>
                                                     <th class="border-0 align-top" width="35%">First time Approved</th>
                                    ...
                                    <td>
                                        ...
                                        <input data-id="{{$sku['sku_id']}}" type="checkbox"checked data-toggle="toggle" data-on="Approved" data-off="Rejected" data-onstyle="success" data-offstyle="warning" data-size="sm" data-width="100" class="toggle-class-wrc"   $sku['sku_code']  ? 'checked' : '' }}>
                                        </div>
                                    </td>
...
$('.toggle-class-wrc').change(function() {
            var qc = $(this).prop('checked') == true ? 1 : 0; 
            var id = $(this).data('id'); 
            alert(id);
            $.ajax({
