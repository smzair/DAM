...
<nav>
 <div >
  ...
  <div class="hidden fixed top-4 px-6 py-4 " style="z-index: -2; text-align: right; padding-top: 16px; padding-right: 15px">
    @auth
    <a href="{{ url('/home') }}" class="text-lg text-gray-900 " style="font-size: 17px">Home</a>
    @else
    <a href="{{ route('login') }}" style="font-size: 20px" class="text-lg text-gray-900 ">  Login  </a>
...
<body >
  ...
  <div class="mobile-magic">
    <img src="{{ asset ('dist/img/wl_mobile.png')}}" alt="ODN" />
  </div>
