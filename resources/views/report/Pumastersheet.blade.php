...
<div class="wrc-cc-content table-responsive" >
    <table class="table table-head-fixed edt-table text-nowrap m-0" id="">
        <thead>
            <tr>
                ...
                <th class="align-middle">Inward to Shoot Ageing</th>
                <th class="align-middle">TAT Start to Shoot Ageing</th>
                 <th class="align-middle">Shoot TAT Status</th>
                <th class="align-middle">Shoot to Submission Ageing</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="align-middle td-data">{{dateFormat($wrc['inward_at'])}}</td>
             <td class="align-middle td-data">{{ \Carbon\Carbon::parse($wrc['inward_at'])->format('F') }}</td>
            <td class="align-middle td-data">{{$wrc['days']}}</td>
            ...
            <td class="align-middle td-data">{{$wrc['inwardwrc_sku_count']}}</td>
                           <td class="align-middle td-data">{{$wrc['wrc_statuses']}}</td>
            ...
            <td class="align-middle td-data">{{($wrc['Tat_days'])}}</td>
            <td class="align-middle td-data">{{($wrc['Inward_to_Shoot'])}}</td>
            <td class="align-middle td-data">{{($wrc['TAT_Start_To_Shoot'])}}</td>
                 <td class="align-middle td-data">{{($wrc['TAT_Start_To_shoot_status'])}}</td>
            <td class="align-middle td-data">{{($wrc['Shoot_to_Submission'])}}</td>
            <td class="align-middle td-data">{{($wrc['TAT_end_date'])}}</td>
            <td class="align-middle td-data">{{($wrc['TAT_status'])}}</td>
            <td class="align-middle td-data">{{($wrc['Internal_fta'])}}</td>
            <td class="align-middle td-data">{{($wrc['External_fta'])}}</td>
    ...
    <td class="align-middle td-data">{{$wrc['statuses']}}</td>
   ...
   <td class="align-middle td-data">{{$wrc['submission_count']}}</td>
            ...
            <td class="align-middle td-data">{{$wrc['model_charges']}}</td>
           <td class="align-middle td-data"></td>
            ...
            <td class="align-middle td-data">{{$wrc['com']}}</td>
               <td class="align-middle td-data">{{$wrc['final_com']}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
